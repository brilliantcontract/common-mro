 ...
 * <h3>Thread Safety</h3>
 * The {@link ImageScaler} class is <strong>thread-safe</strong> (as all the
 * methods are <code>static</code>); this class maintains no internal state
 * while performing any of the provided operations and is safe to call
...
public class ImageScaler {
    ...
    public static enum Method {
         ...
         * {@link ImageScaler#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs
         * to decide between selecting the <code>QUALITY</code>,
    ...
    public static enum Mode {
         ...
         *
         * See "Image Proportions" in the {@link ImageScaler} class description
         * for more detail.
         */
        AUTOMATIC,
        /**
     ...
     * {@link ImageScaler#THRESHOLD_BALANCED_SPEED} thresholds when selecting
     * which method should be used by comparing the primary dimension (width or
